...
class BuyerRegistration extends React.Component {
  state = {};
  ...
  verifySubmit = (values) => {
    ...
    if (password_1.match(form_regex)) {
      ...
      message.error(
        "Your Passwords must contain at least one Uppercase \n one special character \n and one numeric digit "
      );
    }
  };
            ...
            <div className="form-box">
              ...
              <Form onFinish={this.verifySubmit} className="form-box-w">
                ...
                <Form.Item name="username">
                  <Input placeholder="Username" enterButton />
                </Form.Item>

                <Form.Item name="email">
                  <Input placeholder="Email" enterButton />
                </Form.Item>
                ...
                >
                  <Input placeholder="Password" enterButton />
                </Form.Item>
                ...
                >
                  <Input placeholder="Confirm Password" enterButton />
                </Form.Item>
              ...
              <div className="">
                ...
                <Link to="#">
                  <p className="access-suggestion">Forgot Password ?</p>
                </Link>
              </div>
            </div>
          </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(BuyerRegistration);
